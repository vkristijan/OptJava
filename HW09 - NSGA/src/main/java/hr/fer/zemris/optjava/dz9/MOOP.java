...
import hr.fer.zemris.optjava.dz9.nsga.crossover.Crossover;
import hr.fer.zemris.optjava.dz9.nsga.crossover.ICrossover;
import hr.fer.zemris.optjava.dz9.nsga.function.*;
import hr.fer.zemris.optjava.dz9.nsga.moop.Evaluate;
import hr.fer.zemris.optjava.dz9.nsga.moop.MOOPProblem;
import hr.fer.zemris.optjava.dz9.nsga.moop.MOOPProblemImpl;
import hr.fer.zemris.optjava.dz9.nsga.mutation.IMutation;
import hr.fer.zemris.optjava.dz9.nsga.mutation.Mutation;
import hr.fer.zemris.optjava.dz9.nsga.selection.ISelection;
import hr.fer.zemris.optjava.dz9.nsga.selection.TournamentSelection;
...
public class MOOP {
    ...
    public static void main(String[] args) throws IOException{
        ...
        ISelection secondSelection = new TournamentSelection(tournamentSize);
        ICrossover crossover = new Crossover();
        IMutation mutation = new Mutation(sigma);

        NSGA nsga = new NSGA(moop, evaluate, populationSize, maxIteration,
